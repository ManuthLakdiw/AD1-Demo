...
public class ManageItemsFormController {
    ...
    private void loadAllItems() {
        ...
        try {
            ...
            ObservableList<ItemTM> itemTMObservableList = tblItems.getItems();
...
//                tblItems.getItems().add(new ItemTM(itemDTO.getCode(),itemDTO.getDescription(),itemDTO.getQtyOnHand(),itemDTO.getUnitPrice()));
                ...
                itemTM.setCode(itemDTO.getCode());
                itemTM.setDescription(itemDTO.getDescription());
                itemTM.setQtyOnHand(itemDTO.getQtyOnHand());
                itemTM.setUnitPrice(itemDTO.getUnitPrice());
                itemTMObservableList.add(itemTM);
            }
    ...
    public void btnSave_OnAction(ActionEvent actionEvent) {
        ...
        if (btnSave.getText().equalsIgnoreCase("save")) {
            try {
                ...
                //Save Item
                ItemDAOImpl itemDAO = new ItemDAOImpl();
                itemDAO.saveItem(new ItemDTO(code, description, qtyOnHand, unitPrice));
            ...
            try {
                ...
                /*Update Item*/
               ItemDAOImpl itemDAO = new ItemDAOImpl();
               itemDAO.updateItem((new ItemDTO(code, description, qtyOnHand, unitPrice))); // Update DB

                // Update the item in the UI (directly in the model)
                ItemTM selectedItem = tblItems.getSelectionModel().getSelectedItem();
                selectedItem.setDescription(description);
                selectedItem.setQtyOnHand(qtyOnHand);
                selectedItem.setUnitPrice(unitPrice);
                tblItems.refresh(); // Refresh the table to reflect changes in the UI
